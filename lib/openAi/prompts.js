class Prompts {
  ...
  getFormalPromptForAudio(transcription) {
    ...
    Return only the refined transcription.
    Preserve the essence and primary intent of the original audio content.
    Rephrase ambiguous or colloquial portions to maintain a formal tone.
